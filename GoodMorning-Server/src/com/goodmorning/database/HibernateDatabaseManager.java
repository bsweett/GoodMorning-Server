...
public abstract class HibernateDatabaseManager {
	...
	protected void closeSession(){
		...
		try {
			HibernateUtility.closeTheThreadLocalSession();
		}
	...
	protected void rollback (Transaction transaction){
		...
		try {
			...
			ServerLogger.getDefault().severe(this, Messages.METHOD_ROLLBACK, Messages.HIBERNATE_FAILED, exception);
		}	
	}
	...
	public synchronized boolean add(Object object){
		...
		try {
			...
			ServerLogger.getDefault().severe(this, Messages.METHOD_ADD, Messages.HIBERNATE_FAILED, exception);					
			return errorResult;
		}	
		catch (RuntimeException exception) {
			rollback(transaction);
			ServerLogger.getDefault().severe(this, Messages.METHOD_ADD, Messages.GENERIC_FAILED, exception);
			return errorResult;
		}
		finally {
			closeSession();
	...
	public synchronized boolean update(Object object){
		...
		try {
			...
			rollback(transaction);
			ServerLogger.getDefault().severe(this, Messages.METHOD_UPDATE, Messages.HIBERNATE_FAILED, exception);
			return errorResult;
		}		
		catch (RuntimeException exception) {
			rollback(transaction);
			ServerLogger.getDefault().severe(this, Messages.METHOD_UPDATE, Messages.GENERIC_FAILED, exception);
			return errorResult;
		}
		finally {
			closeSession();
	...
	public synchronized boolean updateAndAdd(Object updateObject, Object addObject){
		...
		try {
			...
			rollback(transaction);
			ServerLogger.getDefault().severe(this, Messages.METHOD_UPDATE_AND_ADD, Messages.HIBERNATE_FAILED, exception);
			return errorResult;
		}		
		catch (RuntimeException exception) {
			rollback(transaction);
			ServerLogger.getDefault().severe(this, Messages.METHOD_UPDATE_AND_ADD, Messages.GENERIC_FAILED, exception);
			return errorResult;
		}
		finally {
			closeSession();
	...
	public synchronized boolean delete(Object object){
		...
		try {
			...
			rollback(transaction);
			ServerLogger.getDefault().severe(this, Messages.METHOD_DELETE, Messages.HIBERNATE_FAILED, exception);
			return errorResult;
		}	
		catch (RuntimeException exception) {
			rollback(transaction);
			ServerLogger.getDefault().severe(this, Messages.METHOD_DELETE, Messages.GENERIC_FAILED, exception);
			return errorResult;
		}
		finally {
			closeSession();
	...
	public synchronized boolean deleteAll(){
		...
		try {
			...
			rollback(transaction);
			ServerLogger.getDefault().severe(this, Messages.METHOD_DELETE_ALL, Messages.HIBERNATE_FAILED, exception);
			return errorResult;
		}	
		catch (RuntimeException exception) {
			rollback(transaction);
			ServerLogger.getDefault().severe(this, Messages.METHOD_DELETE_ALL, Messages.GENERIC_FAILED, exception);
			return errorResult;
		}
		finally {
			closeSession();
